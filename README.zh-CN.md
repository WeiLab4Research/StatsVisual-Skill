...
<p align="center">
  <img src="assets/readme/hero.svg" width="100%" alt="StatsVisual-Skill — 让 AI 先检查数据，再推荐合适图形，一键生成四大医学期刊级别的出版图">
</p>
...
让 AI 助手在绘图前先理解数据结构，再推荐最合适的统计图形，生成可复现的 R 代码，并导出符合 Lancet、NEJM、JAMA、BMJ 等期刊标准的出版级图形。绘图理念来源于北京大学魏永越教授主编的《统计图形与艺术》——将"信、达、雅"融入医学可视化：忠实于数据，清楚表达科学发现，以克制精致的形式呈现证据。

## 效果展示

<p align="center">
  <img src="assets/readme/section-gallery.svg" width="100%" alt="三组绘图效果对比">
</p>
...
<p align="center">
  <img src="assets/readme/workflow.svg" width="100%" alt="工作流：提供数据 → 数据画像 → 推荐图形 → 生成出版图">
</p>

核心设计原则：**首轮先分析，确认再绘图**。第一次收到数据时只做数据画像和图形推荐，不直接生成代码。用户确认后，自动生成 R 脚本、图形说明和可复现材料。

## 图形大类概览

<p align="center">
  <img src="assets/readme/section-charts.svg" width="100%" alt="16 种统计图形大类">
</p>
...
<p align="center">
  <img src="assets/readme/section-install.svg" width="100%" alt="安装指南">
</p>
...
assets/
  ...
  readme/                   # README 视觉素材
skills/
  StatsVisual-Skill/        # 核心绘图 skill
    SKILL.md
    agents/
    assets/                 # 模板脚本、预览图
    references/             # 16 种图形参考文档 + 期刊风格指南
    scripts/                # 依赖安装与验证脚本
  r-journal-style-calibrator/  # 期刊风格扩展 skill
```
...
本项目灵感亦参考 [Yuan1z0825/nature-skills](https://github.com/Yuan1z0825/nature-skills)，但定位有所不同。本项目主要聚焦四大医学期刊（The Lancet、NEJM、JAMA、BMJ）的医学统计绘图原则，并结合《统计图形与艺术》的知识框架，覆盖更丰富的图形类型。
