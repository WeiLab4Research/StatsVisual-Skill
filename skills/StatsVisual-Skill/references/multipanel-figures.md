...
Use `assets/templates/multipanel_plot/multipanel_helpers.R` and `assets/templates/multipanel_plot/multipanel_figure.R` only as starting points. Before adapting either template, write the layout plan and decide whether automatic `patchwork` composition is sufficient.
